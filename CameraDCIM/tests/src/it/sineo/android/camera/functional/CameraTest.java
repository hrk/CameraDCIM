package it.sineo.android.camera.functional;
...
public class CameraTest extends InstrumentationTestCase {
    ...
    private static final String CAMERA_ACTIVITY = "it.sineo.android.camera.Camera";
    private static final String CAMCORDER_ACTIVITY = "it.sineo.android.camera.VideoCamera";
