...
package it.sineo.android.camera.stress;

import it.sineo.android.camera.VideoCamera;
 ...
 *    -e class it.sineo.android.camera.stress.SwitchPreview \
 *    -w it.sineo.android.camera.tests/it.sineo.android.camera.CameraStressTestRunner
 *
 */
        ...
        try{
            ...
            for (int i=0; i< TOTAL_NUMBER_OF_SWITCHING; i++) {
                ...
                intent.setClassName("com.google.android.camera",
                        "it.sineo.android.camera.VideoCamera");
                getActivity().startActivity(intent);
                Thread.sleep(WAIT_FOR_PREVIEW);
                intent.setClassName("com.google.android.camera",
                "it.sineo.android.camera.Camera");
                getActivity().startActivity(intent);
                mOut.write(" ," + i);
                mOut.flush();
            }
