...
public class CameraStartUp extends InstrumentationTestCase {
    ...
    private static final String CAMERA_ACTIVITY_NAME = "it.sineo.android.camera.Camera";
    private static final String VIDEORECORDER_ACTIVITY_NAME = "it.sineo.android.camera.VideoCamera";
