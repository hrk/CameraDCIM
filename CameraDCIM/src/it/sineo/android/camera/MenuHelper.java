...
public class MenuHelper {
    ...
    private static final String CAMERA_CLASS = "it.sineo.android.camera.Camera";
    private static final String VIDEO_CAMERA_CLASS = "it.sineo.android.camera.VideoCamera";
